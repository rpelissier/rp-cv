...
export const profileData: ProfileData = {
    ...
    education: [
        ...
        },
        {
            ...
            period: "2000 - 2003",
            description: "General engineering degree with a major in computer science, automatic control and signal processing. Coursework included applied mathematics, algorithms, and project management.",
